...
| Terraform providers | *in progress*; one provider kind among many         | the whole mechanism — every OpenTofu or Terraform provider, day one |
| Written in          | Rust                                                | Go                                                                  |
...
::: {.fragment}
So it is **scope**, and it is licensing. NixOps is building a platform.
