...
include-in-header:
  - text: |
      ...
      .on-top { z-index: 10; }
      /* reveal gives `section img` a border, a background tint and a shadow.
         An absolutely-placed mark wants none of those. */
      .reveal section img.absolute {
        background: none; border: none; box-shadow: none; margin: 0;
      }
      /* a slide with marks down the right-hand side keeps its text narrow */
      .marks-right > p,
      .marks-right > ol,
      .marks-right > ul { width: 62%; }
      /* for artwork that has its own white background */
      .reveal section img.card {
        border-radius: 16px;
...
![](img/elastinix-logo.png){.absolute .on-top top=0 right=70 width="200"}
...
- What are your opinions about one of these combinations?
-->
...
## Baked vs. Brewed {.center .marks-right}

![](img/elastinix-baked.png){.absolute .on-top top=120 right=45 width="200"}
![](img/elastinix-brewed.png){.absolute .on-top top=380 right=35 width="220"}
